...
public protocol GraphQLListener: ParseTreeListener {
	 ...
	 * Enter a parse tree produced by {@link GraphQLParser#executableDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterExecutableDocument(_ ctx: GraphQLParser.ExecutableDocumentContext)
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#executableDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitExecutableDocument(_ ctx: GraphQLParser.ExecutableDocumentContext)
	/**
	 ...
	 * Enter a parse tree produced by {@link GraphQLParser#type_}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterType_(_ ctx: GraphQLParser.Type_Context)
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#type_}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitType_(_ ctx: GraphQLParser.Type_Context)
	/**
	 ...
	 * Enter a parse tree produced by {@link GraphQLParser#typeSystemDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterTypeSystemDocument(_ ctx: GraphQLParser.TypeSystemDocumentContext)
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#typeSystemDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitTypeSystemDocument(_ ctx: GraphQLParser.TypeSystemDocumentContext)
	/**
	 ...
	 * Enter a parse tree produced by {@link GraphQLParser#typeSystemExtensionDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func enterTypeSystemExtensionDocument(_ ctx: GraphQLParser.TypeSystemExtensionDocumentContext)
	/**
	 * Exit a parse tree produced by {@link GraphQLParser#typeSystemExtensionDocument}.
	 - Parameters:
	   - ctx: the parse tree
	 */
	func exitTypeSystemExtensionDocument(_ ctx: GraphQLParser.TypeSystemExtensionDocumentContext)
	/**
